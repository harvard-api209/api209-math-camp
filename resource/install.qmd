...
**Original Content**: [Prof. Andrew Heiss](https://datavizf24.classes.andrewheiss.com/)
...
2. Click on "Download R for `XXX`", where `XXX` is either Mac or Windows:
     ...
     ![](../files/img/install/install-r-links.png)
   ...
   - If you use macOS, scroll down to the first `.pkg` file in the list of files (in this picture, it's `R-4.0.0.pkg`; as of right now, the current version is 4.4.0) and download it.
     ...
     ![](../files/img/install/install-r-mac.png)
    
   - If you use Windows, click "base" (or click on the bolded "install R for the first time" link) and download it. 
   
     ![](../files/img/install/install-r-windows.png)
...
2. The website should automatically detect your operating system (macOS or Windows) and show a big download button for it:
   ...
   ![](../files/img/install/install-r-rstudio1.png)
    
   If not, scroll down a little to the large table and choose the version of RStudio that matches your operating system.

   ![](../files/img/install/install-r-rstudio2.png)
...
![](../files/img/install/install-r-package-panel.png)
...
![](../files/img/install/install-r-tidyverse.png)
