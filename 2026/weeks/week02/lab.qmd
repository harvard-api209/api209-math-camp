...
Ask Codex or Claude Code to do one of the following:

- propose a clearer chart title and subtitle;
- suggest one alternative visualization and explain why it might work better;
- critique your axis choices, labels, or color decisions.

Your job is to decide whether the advice improves the plot and to justify that decision in 2 to 3 sentences.
