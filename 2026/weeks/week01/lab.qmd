...
- If you haven't installed R and RStudio, use the following [**Posit Cloud project**](https://posit.cloud/content/8531422)
...
Use Codex or Claude Code for one narrow task only:

- ask for a short plan to check missing values;
- ask for one `dplyr` pipeline to summarize medals by country;
- ask for an explanation of an error message if your code fails.

Then write down:

1. what prompt you used;
2. what the tool got right;
3. what you still had to verify manually.
