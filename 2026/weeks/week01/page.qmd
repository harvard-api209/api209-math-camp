...
::: {.lesson-hero}
<div class="eyebrow">Week 01</div>

The opening week sets the operating logic for the rest of the camp: how the course runs, how to approach R practice, and how to build enough fluency in wrangling to move quickly once the semester starts.

<div class="lesson-tags">
  <span class="lesson-chip">course structure</span>
  <span class="lesson-chip">R workflow</span>
  <span class="lesson-chip">data wrangling</span>
</div>
:::
...
Either click on the slide area below or click [here](slides01.qmd) to view it in fullscreen.
