...
::: {.fragment}
::: {.v-center}
[Rony Rodriguez-Ramirez (G4)]{.box-inv-crimson}
:::
:::
...
- **Use AI for bounded debugging, not for outsourcing the whole assignment**
- **Codex and Claude Code are especially useful when you include context**
  1. [Paste the error message]{.small}
  2. [Show the smallest code chunk that reproduces it]{.small}
  3. [State what you expected to happen]{.small}
  4. [Run the fix yourself and check the output]{.small}

- **What these tools are good at**
  - [Explaining syntax errors and package conflicts]{.small}
  - [Suggesting a cleaner data wrangling pipeline]{.small}
  - [Helping you read an unfamiliar codebase or script]{.small}

## AI rules for this camp

:::{.small}
- Ask for one step at a time.
- Never submit code you have not run.
- Keep a short record of the prompts that materially shaped your work.
- Treat every model answer as a draft that needs verification.
:::
