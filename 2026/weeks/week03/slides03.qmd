...
- AI can accelerate coding and drafting, but it also makes undocumented changes easier to hide.
- Your protection is a transparent workflow: scripts, Quarto files, clear prompts, and visible outputs.
- If Codex or Claude Code helped you write code, the final document should still show what you ran and what you concluded.

## A simple rule for fall semester

:::{.center-txt}
[If AI helped produce it, you should be able to rerun it and explain it.]{.box-inv-crimson-med}
:::
