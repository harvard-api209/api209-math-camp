...
After you finish the lab, ask Codex or Claude Code for one of the following:

- a code review of your cleaning pipeline;
- a suggestion for one robustness check;
- a clearer paragraph interpreting your final figure.

Keep only the parts you can justify from your actual output.
