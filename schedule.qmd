...
- [**Assignment**](/assignment/index.qmd) ({{< fa pen-ruler >}}): This page contains the instructions for either the session exercise or the labs. **Assignments are <del>due</del> by 11:59 PM on the Monday**.
