...
- [**Lessons**](/content/index.qmd) ({{< fa book-open-reader >}}): This page contains the slides for the topic. Read and watch these first.

- [**Labs**](/lesson/index.qmd) ({{< fa chalkboard-teacher >}}): This page contains, when needed, interactive sessions, and also the contents for each lab. Go through these after doing the lessons.
...
- Do everything on the lewsson page ({{< fa book-open-reader >}})
- Work through the labs page ({{< fa chalkboard-teacher >}})
