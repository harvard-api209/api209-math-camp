...
- [**Hands-on Sessions**](/hands-on/index.qmd) ({{< fa laptop-code >}}): This page provides the interactive, practical exercises that correspond with each lesson. Engage with these sessions after reviewing the slides to solidify your understanding. We will go through these during each odd numbered session.
