...
<div style="display: flex; gap: 30px;">
  <a href="2026/index.qmd">
    <button class="button-61">Summer 2026</button>
  </a>

  <a href="2025/index.qmd">
    <button class="button-61">Summer 2025</button>
  </a>

  <a href="2024/index.qmd">
    <button class="button-61">Summer 2024</button>
  </a>
</div>
...
- **Automate and Reproduce Research Workflows:** Use Quarto and workflow automation tools to create reproducible, efficient research workflows.
- **Use AI Responsibly in Quantitative Work:** Integrate AI assistants into coding, exploratory analysis, and reporting while documenting prompts, checking outputs, and validating substantive claims.
